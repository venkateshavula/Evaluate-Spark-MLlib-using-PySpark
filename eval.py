...
##### Evaluate the classifier
 def evaluate(predictions):
    ...
    print "\n Accuracy= %s; Sensitivity= %s; Specificity= %s; Precision= %s \n F-measure= %s;Matthews correlation coefficient= %s; Cohen's Kappa coefficient= %s" %(round(accuracy*100,2),round(recall*100,2),round(spec*100,2),round(precision*100,2),round(fscore,4),
